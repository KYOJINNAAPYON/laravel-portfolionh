...
<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto flex flex-col">
        <div class="lg:w-4/6 mx-auto">
            ...
            <img alt="content" class="object-cover object-center h-full w-full" src="img/Nana Hirotsu.png">
            </div>
            <div class="flex flex-col sm:flex-row mt-10">
            <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-40 h-40 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400" img src="img/about_nana.jpeg">
                <img src="img/about_nana.jpeg" class=" rounded-full">
                </div>
            <div class="flex flex-col items-center text-center justify-center">
                <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Nana Hirotsu</h2>
                <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
            </div>
            </div>
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p class="leading-relaxed text-sm mb-4">
                初めまして。数ある中から私のポートフォリオサイトに足を運んでくださり、ありがとうございます。<br>
                福岡県在住。2024年1月で30歳になりました。<br>
                パソコンがあれば、場所を選ばずにお仕事ができることに魅了を感じ、2022年11月よりプログラミング学習を始めました。<br>
                HTML/CSS、javaScript、jQueryをはじめ、WordPress、PHP、Laravelの学習まで一通り学習いたしました。<br>
                一日でも早くエンジニアとして働けるように、日頃からGitを使ってのシステム構築や、GitHubでソース管理を行っております。<br>
                まだお仕事としての経験は浅いですが、足りない知識はキャチアップし、自走力のあるエンジニアとして活躍できるよう精一杯やらせていただきます。<br>
                </p>
...
<section class="text-gray-600 body-font lg:w-4/6 mx-auto">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
            <h1 class="text-2xl font-medium title-font mb-4 text-gray-900 tracking-widest">Portfolio</h1>
        </div>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto lg:w-4/6 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
